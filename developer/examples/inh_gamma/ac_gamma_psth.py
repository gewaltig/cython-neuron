...
# Simulate the PSTH of a sinusoidally modulated inh_gamma_generator
...
tbins = numpy.arange(0.0,tsim,dt/1000)

# modulation frequency of 4.0
omega = 2.0*numpy.pi*4.0

f = 6.0 + 2.0*numpy.sin(omega*tbins)
...
plot(tbins,[0.0]+list(f[:-1]),'r-',lw=3)
