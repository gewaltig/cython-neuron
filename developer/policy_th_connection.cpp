...
{
  //
  // Implementation of class Policy_TH_CommonProperties.
  //

  Policy_TH_CommonProperties::Policy_TH_CommonProperties() :
  ...
  void Policy_TH_CommonProperties::get_status(DictionaryDatum & d) const
  {
    ...
    def<double_t>(d, "limita", limita_);
   
    
  }
  
  void Policy_TH_CommonProperties::set_status(const DictionaryDatum & d, ConnectorModel &cm)
  {
    ...
    updateValue<double_t>(d, "limita", limita_);

  }


  Node* Policy_TH_CommonProperties::get_node()
   {
     if(vt_==0)
  ...
  //
  // Implementation of class Policy_TH_Connection.
  //

   Policy_TH_Connection::Policy_TH_Connection() : 
     last_update_(0),
     last_dopa_spike_(0),
     dopa_trace_(0.15365),
     pre_k_(0.0),
  ...
  Policy_TH_Connection::Policy_TH_Connection(const Policy_TH_Connection &rhs) :
    ConnectionHetWD(rhs)
  {
  ...
  void Policy_TH_Connection::get_status(DictionaryDatum & d) const
   {
 ...
 // own properties, different for individual synapse
  ...
  void Policy_TH_Connection::set_status(const DictionaryDatum & d, ConnectorModel &cm)
  {
...
//       }
   ...
   */  
  void Policy_TH_Connection::set_status(const DictionaryDatum & d, index p, ConnectorModel &cm)
  {
  ...
  //}
   ...
   void Policy_TH_Connection::initialize_property_arrays(DictionaryDatum & d) const
  {
   ...
   */
  void Policy_TH_Connection::append_properties(DictionaryDatum & d) const
  {
