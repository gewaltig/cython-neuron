...
#ifndef MATURING_CONNECTOR_FR_H
#define MATURING_CONNECTOR_FR_H
...
class MaturingConnectorFr :
  public GenericConnectorBase< MaturingConnectionFr,
                               MaturingCommonPropertiesFr,
                               GenericConnectorModelBase< MaturingConnectionFr, MaturingCommonPropertiesFr, MaturingConnectorFr >
                             >
  {

  // this is the ConnectorModel specialization which belongs to this kind of Connector specialization
  typedef GenericConnectorModelBase< MaturingConnectionFr, MaturingCommonPropertiesFr, MaturingConnectorFr > GCMT;
...
#endif /* #ifndef MATURING_CONNECTOR_FR_H */
