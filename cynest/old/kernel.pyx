...
# new classes
#cdef class Buffer:
#    cdef classes.Buffer *thisptr
#    def __cinit__(self):
#        self.thisptr= new classes.Buffer()
        
#    def __dealloc__(self):
#        del self.thisptr

#   def putValue(self, *value):
#        self.thisptr.putValue(value)


#cdef updateSSO():
#        print "Finally Updating!!!"
...
cdef class NESTEngine:
	...
	# check if dynamic neuron
        if "cython_neuron" in command_bytes and "CheckDynamicNeuron" in command_bytes:
                buff = Buffer()
                buff.setValue(updateSSO)
                return True
        else:
