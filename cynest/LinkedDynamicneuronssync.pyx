...
cdef double get_ms(int arg1, long arg2, double arg3):
    return spFct.get_ms(arg1, arg2, arg3)

cdef long get_tics_or_steps(int arg1, int arg2, long arg3, double arg4):
    return spFct.get_tics_or_steps(arg1, arg2, arg3, arg4)

cdef unsigned int get_scheduler_value(int arg1, unsigned int arg2):
    return spFct.get_scheduler_value(arg1, arg2)
...
cdef void setNeuronMembers(bytes neuronName, int neuronID, classes.Datum* parameters) with gil:
    ...
    setNeuronParams(neuronID, members)
# __________________________________________________________________________________________________________________________
...
cdef void retrieveNeuronMembers(bytes neuronName, int neuronID, classes.Datum* parameters) with gil:
    ...
    cdef classes.Datum* members = converter.objectToDatum(getNeuronParams(neuronID))
# __________________________________________________________________________________________________________________________
...
cdef void updateNeuron(bytes neuronName, int neuronID):
    ...
    setStdVars(neuronID, sp.spike[0], sp.in_spikes[0], sp.ex_spikes[0], sp.currents[0], sp.lag[0])

    update(neuronID)

    getStdVars(neuronID, sp.spike, sp.in_spikes, sp.ex_spikes, sp.currents, sp.lag)
# __________________________________________________________________________________________________________________________
    #sp.spike[0] = sI.value
